...
Проект из первого спринта курса "Микросервисная архитектура" на Яндекс.Практикум 22.09 - 05.10 МД.
...
## Задачи их решения
[Задание 1. Разработка вариантов решений](Task1)  
[Задание 2. Проработка высокоуровневого видения решений](Task2)  
[Задание 3. Детализация решений](Task3)  
[Задание 4. Проработка критериев выбора решения](Task4)  
